      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen md:w-20 lg:w-[275px] border-r border-border p-2 lg:p-4 flex-col">
        ...
        <nav className="flex-1 space-y-1">
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.path}
                className={cn(
                  "flex items-center gap-4 px-3 lg:px-4 py-3 text-xl rounded-full transition-colors duration-200 hover:bg-secondary",
          ...
          <Button
            ...
            className="w-full mt-4 py-6 text-lg font-bold rounded-full bg-primary hover:bg-primary/90 lg:block"
          >
            <Feather className="w-5 h-5 lg:mr-2" />
