      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen md:w-20 lg:w-[275px] border-r border-border p-2 lg:p-4 flex-col">
        ...
        {authUser ? (
          ...
          <div className="mt-auto flex flex-col gap-2">
            {/* Mobile: single icon link */}
            <Link
              href="/login"
              className="flex lg:hidden items-center justify-center p-3 hover:bg-secondary rounded-full transition-colors"
              title="Log in"
            >
            ...
            <div className="hidden lg:flex flex-col gap-2">
              <Link
                href="/register"
                className="flex items-center justify-center h-[52px] text-[17px] font-bold rounded-full bg-primary hover:bg-primary/90 text-primary-foreground transition-colors"
              >
                Create account
              </Link>
              <Link
                href="/login"
                className="flex items-center justify-center h-[52px] text-[17px] font-bold rounded-full border border-border hover:bg-secondary transition-colors"
              >
                Log in
              </Link>
            </div>
